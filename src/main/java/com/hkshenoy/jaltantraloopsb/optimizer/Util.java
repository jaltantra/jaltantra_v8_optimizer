...
public class Util {
	...
	{
		return 10.68 * length * Math.pow((Math.abs(flow)*0.001)/HWConstant, 1.852)/Math.pow((diameter/1000),4.87);
	}
	...
	{
		return 10.68 * Math.pow(Math.abs((flow*0.001))/HWConstant, 1.852)/Math.pow((diameter/1000),4.87);
	}
